...
<!-- header section start -->
 ...
 <div class="button-container">
   ...
   <script>
     ...
     window.location.href = "View Laptop page.php";
        }
   </script>
              ...
              <p class="text-white text-center">"It’s more than a laptop – it’s a way of life"</p>
                <div class="card mt-4">
                    <div class="card-body py-2">
                        <div class="row">
                            <div class="col-lg-3">
                              <button onclick="scrollToSection('section1')" class="btn2">HP</button>
                          </div>
                          <div class="col-lg-3">
                              <button onclick="scrollToSection('section2')" class="btn2">Asus</button>
                          </div>
                          <div class="col-lg-3">
                              <button onclick="scrollToSection('section3')" class="btn2">Dell</button>
                          </div>
                          <div class="col-lg-3">
                              <button onclick="scrollToSection('section4')" class="btn2">Lenovo</button>
                          </div>
                </div>
                                </div>
                        </div>
...
<section id="section1" class="laptops py-1">
...
<section  id="section2"class="laptops py-1">
       <div class="container py-4">
...
<section id="section3" class="laptops py-1">
    <div class="container py-4">
...
<section  id="section4"class="laptops py-1">
    <div class="container py-4">
