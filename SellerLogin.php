...
<body style="background-image: linear-gradient( to top,rgba(0,0,0,0.5)50%, rgba(0,0,0,0.5)50%),url(images/1.jpg);background-repeat: no-repeat;">
 <div>
  <marquee style="margin-top: 100px; color: white; font-weight: bold; font-size:80px; font-family:monospace;" behavior="alternate" direction="right">LOG IN HERE</marquee>
</div>
<div style="margin-top:200px; margin-left:350px; margin-right:300px; margin-top:7px; background-color:#FBFBFB; margin-bottom: 100px; width:700px;" class="container">
  <div class="header">
    ...
    <h4 style="color:white;"><i>Only For Seller</i></h4>
  </div>
    <form  id="form" class="form" method="POST" action="Sellersave.php">
    <div class="form-control">
     ...
     <div class="form-control">
      ...
      <input type="password" name="password" placeholder="Enter password" size="6" required>
      <i class="fas fa-check-circle"></i>
      <i class="fas fa-exclamation-circle"></i>
      <small>Error message</small>
    </div>
